...
**Navigation:** [Home](/) > [runtime](/AgentSite/runtime/index.md)
...
- [Output Principles](/AgentSite/output/index.md) for response style, citations, and token output constraints
- [SOUL Layer](/AgentSite/soul/index.md) for identity, truth, and behavior constraints
