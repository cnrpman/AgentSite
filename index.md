...
|---------------------------|-------|-----|
| agent identity, hard rules, truth constraints | [soul](/AgentSite/soul/) | Stable behavior and runtime rules |
| user preference shaping, defaults, wallet conventions | [memory](/AgentSite/memory/) | User-specific but durable context |
| real capabilities, parameters, execution setup | [tool](/AgentSite/tool/) | Primary source of runtime behavior |
| whether there are standalone skills | [skill](/AgentSite/skill/) | Placeholder only at the moment |
...
- In most cases, start with [tool](/AgentSite/tool/) if the question is operational
- Read [soul](/AgentSite/soul/) only when behavior rules or output policy matter
- Read [memory](/AgentSite/memory/) when user preference shaping matters
- Read [skill](/AgentSite/skill/) only to confirm that skills are currently just a placeholder
...
- [memory](/AgentSite/memory/)
- [skill](/AgentSite/skill/)
- [soul](/AgentSite/soul/)
- [tool](/AgentSite/tool/)
