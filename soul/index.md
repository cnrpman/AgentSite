...
**Navigation:** [Home](/) > [soul](/AgentSite/soul/)
...
| Aspect | Content | Page |
|--------|---------|------|
| Core Rules | Identity, scope, operating principles, truth policy | [core](/AgentSite/soul/core/) |
| Runtime Rules | Supported chains, response format, token handling | [runtime](/AgentSite/soul/runtime/) |

**Key principle**: Nothing in SOUL depends on who the user is. If you need user-specific behavior, see [memory](/AgentSite/memory/).
...
- [core](/AgentSite/soul/core/)
- [runtime](/AgentSite/soul/runtime/)
